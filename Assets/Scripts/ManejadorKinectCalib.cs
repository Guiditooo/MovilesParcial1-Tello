...
public class ManejadorKinectCalib : MonoBehaviour 
{
	...
	void Update () 
	{
		...
		if(Input.GetKeyDown(KeyCode.Keypad3))
        {
            ...
            if (ParaAct.Length >= 3) ParaAct[2].SetActive(true);
        }
		if(Input.GetKeyDown(KeyCode.Return) || Input.GetKeyDown(KeyCode.Backspace) || Input.GetKeyDown(KeyCode.KeypadEnter) || Input.GetKeyDown(KeyCode.Mouse0))
		{
